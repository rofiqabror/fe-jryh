                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <a href="javascript:void(0);"
                                    class="bg-primary text-white text-center p-4 fs-20 d-block rounded"
                                    data-toggle="modal" data-target="#addMoreTraining"><?php echo $a; ?></a>
                                <!-- Modal -->
                    ...
                    <div class="col-xl-12 col-md-6">
                        <div class="card">
                            <div class="card-header flex-wrap border-0 pb-0">
                                ...
                                <a href="workout-statistic.html" class="btn btn-outline-light btn-rounded">Set
                                    Target</a>
                            </div>
                            <div class="card-body">
                                <div class="d-flex mb-sm-5 mb-3">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["rgb(255, 148, 50)", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>2/8</span>
                                        <small>
                                    ...
                                    <div>
                                        <h4 class="fs-18 text-black">Lari (45%)</h4>
                                ...
                                <div class="d-flex mb-sm-5 mb-3">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["rgb(30, 167, 197)", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>6/8</span>
                                        <small>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div>
                                        <h4 class="fs-18 text-black">Sepeda (66%)</h4>
                                        <span>69km/20km</span>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["rgb(192, 70, 211)", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>2/8</span>
                                        <small>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="kelas" class="section">
                        <div class="container">
                            <div class="section__header">
                                <h2 class="segment-title">Donasi Pilihan</h2>
                                <p>Peserta IDCamp dapat memilih <em>learning path</em> (alur belajar) utama, antara
                                    lain:</p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3 ">
                                    <div class="card learning-path">
                                        <div class="card-body">
                                            <img src="https://idcamp.indosatooredoo.com/images/learningpaths/android.png"
                                                alt="Android Developer" class="img-fluid d-block mx-auto mb-3"
                                                width="50%">
                                            <h3 class="text-center h5 learning-path__title" style="height: 21.3333px;">
                                                Android Developer</h3>
                                            <p class="learning-path__description" style="height: 158.667px;">Kurikulum
                                                disusun oleh Dicoding sebagai satu-satunya Google Developers Authorized
                                                Training Partner</p>
                                            <div class="text-right">
                                                <a href="https://www.dicoding.com/learningpaths/7">Lihat Detail <i
                                                        class="fas fa-chevron-right"></i></a>
                                            </div>
                                            <div class="col-md-4 mb-3 ">
                                                <div class="card learning-path">
                                                    <div class="card-body">
                                                        <img src="https://idcamp.indosatooredoo.com/images/learningpaths/frontend-web.png"
                                                            alt="Front-End Web Developer"
                                                            class="img-fluid d-block mx-auto mb-3" width="50%">
                                                        <h3 class="text-center h5 learning-path__title"
                                                            style="height: 21.3333px;">Front-End Web Developer</h3>
                                                        <p class="learning-path__description"
                                                            style="height: 158.667px;">Kurikulum disusun oleh Dicoding
                                                            dan pelaku industri di bidang Web Development.</p>
                                                        <div class="text-right">
                                                            <a href="https://www.dicoding.com/learningpaths/22">Lihat
                                                                Detail <i class="fas fa-chevron-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-3 ">
                                                <div class="card learning-path">
                                                    <div class="card-body">
                                                        <img src="https://idcamp.indosatooredoo.com/images/learningpaths/ios.png"
                                                            alt="iOS Developer" class="img-fluid d-block mx-auto mb-3"
                                                            width="50%">
                                                        <h3 class="text-center h5 learning-path__title"
                                                            style="height: 21.3333px;">iOS Developer</h3>
                                                        <p class="learning-path__description"
                                                            style="height: 158.667px;">Kurikulum disusun oleh Dicoding
                                                            dan pelaku industri di bidang iOS Development.</p>
                                                        <div class="text-right">
                                                            <a href="https://www.dicoding.com/learningpaths/9">Lihat
                                                                Detail <i class="fas fa-chevron-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <table class="table table-responsive-md">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><span
                                                                        class="badge light badge-success">Successful</span>
                                                                </td>
                                                                <td>$21.56</td>
                                                                <td>
                                                                    <div class="dropdown">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>01 August 2020</td>
                                                                <td><span
                                                                        class="badge light badge-danger">Canceled</span>
                                                                </td>
                                                                <td>$21.56</td>
                                                                <td>
                                                                    <div class="dropdown">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>01 August 2020</td>
                                                                <td><span
                                                                        class="badge light badge-warning">Pending</span>
                                                                </td>
                                                                <td>$21.56</td>
                                                                <td>
                                                                    <div class="dropdown">
                                            ...
                                            <div class="card-header d-sm-flex d-block pb-0 border-0">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="mr-auto pr-3">
                                                        ...
                                                        <p class="fs-13 mb-0 text-black">Lorem ipsum dolor sit amet,
                                                            consectetur</p>
                                                    </div>
                                                </div>
                                                <div class="dropdown mt-sm-0 mt-3">
                                                    <button type="button"
                                                        class="btn rounded border border-light dropdown-toggle"
